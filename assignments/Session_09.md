## Due before class on Friday, 11/7
...
Save the completed project as "SS5-[FirstName + Last Initial]" (for example, "SS5-IanP"). Submit to your class Github repo **before the beginning of class on 11/7**.   
